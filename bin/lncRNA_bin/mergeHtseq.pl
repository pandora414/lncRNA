...
usage: perl $0 <indir> <control names> <case names> <control group name> <case group name> <outname prefix> <outdir>
USAGE

my ($indir,$control,$case,$con_group,$case_group,$outname,$outdir) = @ARGV;
die $usage if (!defined $indir or !defined $outname or !defined $control or !defined $case or !defined $con_group or !defined $case_group);
