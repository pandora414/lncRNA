...
system(" /DG/programs/beta/rel/R-3.0.2/bin/R --slave <$Bin/align.Rscript --args -o $out/$samplename.align.txt,$samplename,$out/$samplename.readDistribution.pdf,$out/$samplename.readDistribution.png")
